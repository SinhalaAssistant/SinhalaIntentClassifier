...
# load dataset
dataset = np.load("new dataset/MFCCFeatures_Deltas_Wpadding_16k_512_fft.npy")   #data/NewMFCCFeaturesWpadding

np.random.shuffle(dataset)
# print(dataset)

print(dataset.shape)
X = dataset[:,0:12337*2].astype(float)  #186576  7150
Y = dataset[:,12337*2]
...
model = Sequential()
model.add(Dense(1000 ,input_dim=12337*2, activation='relu',kernel_regularizer=regularizers.l1(0.001))) #500   #kernel_regularizer=regularizers.l2(0.1),
